...
class CustomUser(AbstractUser):
    ...
    state = models.ManyToManyField('siyyana_app.State', null=True, blank=True,related_name='customuser_state')
    district = models.ManyToManyField('siyyana_app.District', null=True, blank=True,related_name='customuser_district')
